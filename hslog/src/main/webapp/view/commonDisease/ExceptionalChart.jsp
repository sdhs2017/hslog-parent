...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>commonDisease/selectYearExceptionalByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>commonDisease/selectAgeOrGradeExceptionalByString.do';
   ...
   function PoorsighPie(){
	    var url='<%=path%>commonDisease/selectExceptionalPieByString.do';
  ...
  //点击柱状图
    function PoorsighBar(){
    	var url='<%=path%>commonDisease/selectZipcodeExceptionalByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>commonDisease/getExceptionalAllChart.do';
