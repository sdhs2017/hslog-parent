...
<body class="gray-bg">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="flot-chart" >
                                    <div id="selectyearx_faty" class="col-sm-12" style="height:500px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
        	$.ajax({//曲线图（X轴：年（2009-2015）；Y轴：肥胖率（%）；Z轴：性别
        		type:'post',
        		dataType:"json", //数据类型 ，必须标注，后端返回数据都是json格式
        		url:'<%=path%>/business/health/basicCharts/nutritional/selectyearx_faty.do',
        		success:function(data){
        			loadEchart(data,'selectyearx_faty');
        		}
        	});
