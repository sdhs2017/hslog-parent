...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>/ophth/getYearPoorsightLineByString.do';
    ...
    function PoorsighLineage(){
    	var url='<%=path%>/ophth/selectYearPoorsightLineByTwoString.do';
   ...
   function PoorsighPie(){
	    var url='<%=path%>/ophth/selectYearPoorsightPieByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>/ophth/selectYearPoorsightBarByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>/ophth/getPoorsightAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"SEX":SEX,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.YearPoorsightLineByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.YearPoorsightPieByString),'PoorsighPie');
    		loadEchart(JSON.parse(data.YearPoorsightLineByTwoString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.YearPoorsightBarByString),'PoorsighBar');
    	}
