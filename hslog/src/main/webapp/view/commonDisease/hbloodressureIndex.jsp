                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="flot-chart" >
                                    <div id="getyearbyhbloodpressureandsex" class="col-sm-12" style="height:500px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        //通过ajax获取echart JSON 进而加载数据
        	$.ajax({//曲线图（X轴：年；Y轴：低血红蛋白；Z轴：性别）
        		...
        		success:function(data){
        			loadEchart(JSON.parse(data.getyearbyhbloodpressureandsex),'getyearbyhbloodpressureandsex');
        		}
        	});
