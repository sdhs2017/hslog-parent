...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>physiquedevelopment/selectDevelopmentLineByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>physiquedevelopment/selectAgeOrGradeDevelopmentLineByString.do';
   ...
   function PoorsighPie(){
	    var url='<%=path%>physiquedevelopment/selectDevelopmentPieByString.do';
  ...
  //点击柱状图
    function PoorsighBar(){
    	var url='<%=path%>physiquedevelopment/selectCityDevelopmentBarByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>physiquedevelopment/getDevelopmentAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"SEX":SEX,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.DevelopmentLineByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.DevelopmentPieByString),'PoorsighPie');
    		loadEchart(JSON.parse(data.AgeOrGradeDevelopmentLineByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.CityDevelopmentBarByString),'PoorsighBar');
    	}
