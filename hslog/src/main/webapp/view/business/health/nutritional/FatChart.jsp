...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>/business/health/basicCharts/nutritional/selectYearFatByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>/business/health/basicCharts/nutritional/selectGradeOrAgeFatByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>/business/health/basicCharts/nutritional/selectZipcodeFatByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>/business/health/basicCharts/nutritional/getFatAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.YearFatByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.GradeOrAgeFatByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.ZipcodeFatByString),'PoorsighBar');
    	}
