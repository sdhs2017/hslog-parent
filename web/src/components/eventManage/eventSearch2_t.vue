<template>
    <div class="content-bg">
        ...
        <div class="event-search-condition">
            <v-search-form :formItem="formConditionsArr" busName="eventSearch2_t"></v-search-form>
        </div>
            ...
            return{
                ...
                tableHead:[
                    ...
                    },
                    {
                        ...
                        width:'150',
                        formatData:(val)=>{
                            if(val == 'debug' || val == 'information' || val == 'notice' || val == 'warning'){
                                return '低危'
                            }else if(val == 'error' || val == 'critical'){
                                return  '中危'
                            }else if(val == 'alert' || val == 'emergency'){
                                return  '高危'
                            }
                        }
                    },
