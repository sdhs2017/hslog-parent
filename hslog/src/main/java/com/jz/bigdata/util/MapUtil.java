...
public class MapUtil {
     ...
     * @return
     */
    public static Map removeMapEmptyKey(Map map){
        Set set = map.keySet();
...
//      if("".equals(str.trim())){ //过滤掉为null、""和" "的值 主函数输出结果map：{2=BB, 1=AA, 5=CC}
    ...
    /**
     * 将json数据转为List<Map<String, Object>>
     * @param json
     * @return
     */
    ...
    public static void main(String [] args){
        String json = "{\"starttime\":\"\",\"endtime\":\"\",\"ip\":\"\",\"hostname\":\"\",\"operation_level\":\"\",\"type\":\"\",\"page\":1,\"size\":12}";
