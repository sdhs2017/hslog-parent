...
<!--                                    </el-form-item>-->
                                    ...
                                    <el-form-item label="文本显示">
                                        <el-switch v-model="yItem.label.show"></el-switch>
                                    </el-form-item>
                        ...
                        <el-collapse>
                            <el-collapse-item title="X轴" class="tablist" v-for="(xItem,i) in chartsConfig.xAxisArr" :key="i">
                                <el-form label-position="top" >
                                    ...
                                    <el-form-item label="间隔类型" v-if="xItem.aggregationType === 'Date'">
                                    ...
                                    <el-form-item label="间隔数值" v-if="xItem.aggregationType === 'Date'">
    ...
    export default {
        ...
        methods:{
            ...
            createChart(xDataArr,yDataArr){
                ...
                //console.log(JSON.parse(JSON.stringify(this.opt)))
