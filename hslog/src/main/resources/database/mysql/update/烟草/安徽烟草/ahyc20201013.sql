/*菜单处理*/
delete `HS_Menu` where menuId='10701'
...
UPDATE `HS_Menu` SET childId='9' WHERE ID='10703'

insert into configuration VALUES ('concurrent_requests','9')

-- ----------------------------
-- Table structure for HS_Button
-- ----------------------------
...
CREATE TABLE `event_group`  (
  ...
  UNIQUE INDEX `UNIQUE_ASSET_GROUP_NAME`(`event_group_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '事件关联组' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for event_group_relations
-- ----------------------------
