...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>nutritional/selectYearFatByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>nutritional/selectGradeOrAgeFatByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>nutritional/selectZipcodeFatByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>nutritional/getFatAllChart.do';
