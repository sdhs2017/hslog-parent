...
<body class="gray-bg">
        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
					     ...
					     <select id="Line_Grade" multiple="multiple"></select><br/>
            ...
            <div class="col-sm-5">
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div class="row">
                        	<div id="PoorsighPie" class="col-sm-12" style="height:250px"></div>
                    	</div>
                    </div>
                </div>  
            </div>
    ...
    function PoorsighLine(){
    	var url='<%=path%>/business/health/basicCharts/commonDisease/selectYearExceptionalByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>/business/health/basicCharts/commonDisease/selectAgeOrGradeExceptionalByString.do';
   ...
   function PoorsighPie(){
	    var url='<%=path%>/business/health/basicCharts/commonDisease/selectExceptionalPieByString.do';
  ...
  //点击柱状图
    function PoorsighBar(){
    	var url='<%=path%>/business/health/basicCharts/commonDisease/selectZipcodeExceptionalByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>/business/health/basicCharts/commonDisease/getExceptionalAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"SEX":SEX,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.YearExceptionalByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.ExceptionalPieByString),'PoorsighPie');
    		loadEchart(JSON.parse(data.AgeOrGradeExceptionalByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.ZipcodeExceptionalByString),'PoorsighBar');
    	}
