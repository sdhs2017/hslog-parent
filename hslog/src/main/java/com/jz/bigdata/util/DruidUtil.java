...
public class DruidUtil {
    private final static String DRUID_DATA_SOURCE_ID = "hs-datasource-";
    /**
    ...
    public static boolean checkConnection(DataSource dataSource) throws SQLException {
        ...
        //赋值给java原生链接对象
        javax.sql.DataSource pool = druidDataSource;
    ...
    public static Connection getConnection(DataSource dataSource) throws SQLException {
        ...
        if(druidDataSource!=null){
            ...
            newDruidDataSource.setTimeBetweenConnectErrorMillis(6000);
            newDruidDataSource.setTestOnBorrow(true);
            try {
    ...
    public static List<Map<String, Object>> executeQuery(Connection conn,String sql, Object[] params) throws SQLException {
        ...
        try{
            rst = executeQueryRS(conn,sql,params);
            result = resultSetToList(rst);
        }catch (Exception e){
     ...
     * @return 结果集
     */
    public static ResultSet executeQueryRS(Connection conn,String sql, Object[] params) throws SQLException {
        ResultSet rst = null;
        try {
            // 调用SQL
