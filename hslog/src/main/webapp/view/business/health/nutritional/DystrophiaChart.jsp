...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	...
    	var url='<%=path%>/business/health/basicCharts/nutritional/selectYearDystrophiayByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>/business/health/basicCharts/nutritional/selectGradeOrAgeDystrophiayByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>/business/health/basicCharts/nutritional/selectZipcodeDystrophiayByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>/business/health/basicCharts/nutritional/getDystrophiayAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.YearDystrophiayByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.GradeOrAgeDystrophiayByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.ZipcodeDystrophiayByString),'PoorsighBar');
    	}
