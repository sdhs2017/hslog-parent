            ...
            'equipment.id'(){
               this.$nextTick(()=>{
                   ...
                   bus.$on(this.busName.clickName,(params)=>{
                       ...
                       if(this.echartType === 'line'){//日志总数
                       ...
                       }else if(this.echartType === 'moreline'){//事件总数
                           ...
                           this.tableCondition.event_levels = params.seriesName;
                           ...
                           this.tableCondition.operation_level = params.name;
                           this.tableHead = this.logTableHead;
                       }else{//事件类型
                           ...
                           this.tableCondition.event_type = params.name;
                           this.tableHead = this.eventTableHead;
                       }
