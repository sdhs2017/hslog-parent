<template>
    <div class="content-bg">
        ...
        <div class="item-wapper">
            ...
            <div class="item-content">
                <eqWinlogHourlyEventCount_moreline :params="hourlyEventParams" :setIntervalObj="hourlyEventIntervalObj"></eqWinlogHourlyEventCount_moreline>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            next(vm => {
                ...
                //修改此组件的name值
                vm.$options.name = 'winEquipmentCharts' + to.query.id;
                ...
                let obj = {
                    path: '/mobile/winEquipmentCharts' + to.query.id,
                    component: 'mobile/equipment/winEquipmentCharts.vue',
                    title: '统计'
                }
                sessionStorage.setItem('/mobile/winEquipmentCharts' + to.query.id, JSON.stringify(obj))
