...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>commonDisease/selectYearLhemoglobinByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>commonDisease/selectAgeOrGradeLhemoglobinByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>commonDisease/selectZipcodeLhemoglobinByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>commonDisease/getLhemoglobinAllChart.do';
