package com.jz.bigdata.components.regex.dataRegex.test;
...
public class DataFormatUtil {
	...
	public static String FormatDate(String dateStr) {
		...
		dateRegFormat.put("[0-9]{4}[-][0-9]{1,2}[-][0-9]{1,2}[ ][0-9]{1,2}[:][0-9]{1,2}[:][0-9]{1,2}",
				"yyyy-MM-dd-HH-mm-ss");
...
//		dateRegFormat.put("^\\d{1,2}\\D+\\d{1,2}\\D+\\d{4}$", "dd-MM-yyyy");// 12.21.2013(日.月.年)
	...
	public static void main(String[] args) {
		String[] dateStrArray = new String[] { 
				"2017-08-10 11:54:34  [DEBUG]  [==>  Preparing: select id, name, level, superiorId, subordinate,orderId,comment from department where 1=1 and level = ? ]  [com.jz.bigdata.common.department.dao.IDepartmentDao.selectAll] debug()[139] [210348] "
//				"2014-03-12 12:05:34" 
//				"2014-03-12 12:05", 
//				"2014-03-12 12", 
//				"2014-03-12",
