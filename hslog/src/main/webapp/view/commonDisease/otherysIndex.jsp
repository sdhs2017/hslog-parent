                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="flot-chart" >
                                    <div id="getyearbyotherandsex" class="col-sm-12" style="height:300px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="flot-chart" >
                                    <div id="getotheranomalies" class="col-sm-12" style="height:300px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        //通过ajax获取echart JSON 进而加载数据
        	$.ajax({//曲线图（X轴：年；Y轴：低血红蛋白；Z轴：性别）
        		...
        		url:'<%=path%>commonDisease/getCompletegraph.do',
        		success:function(data){
        			loadEchart(JSON.parse(data.getyearbyotherandsex),'getyearbyotherandsex');
        			loadEchart(JSON.parse(data.getotheranomalies),'getotheranomalies');
        		}
        	});
