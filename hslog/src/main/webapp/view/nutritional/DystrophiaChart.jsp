...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	...
    	var url='<%=path%>nutritional/selectYearDystrophiayByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>nutritional/selectGradeOrAgeDystrophiayByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>nutritional/selectZipcodeDystrophiayByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>nutritional/getDystrophiayAllChart.do';
