...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>/business/health/basicCharts/commonDisease/selectYearLhemoglobinByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>/business/health/basicCharts/commonDisease/selectAgeOrGradeLhemoglobinByString.do';
    ...
    function PoorsighBar(){
    	var url='<%=path%>/business/health/basicCharts/commonDisease/selectZipcodeLhemoglobinByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>/business/health/basicCharts/commonDisease/getLhemoglobinAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.YearLhemoglobinByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.AgeOrGradeLhemoglobinByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.ZipcodeLhemoglobinByString),'PoorsighBar');
    	}
