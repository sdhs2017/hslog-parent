		...
		$.ajax({
			...
			success:function(data){
				...
				if(data.success=="true"){
	            	window.location.href="view/index-n.jsp";
           ...
           <!--  <h3>欢迎使用</h3> -->
            ...
            <form id="loginForm" class="m-t" role="form" onsubmit="return false">
                ...
                <div class="form-group btnBox">
                	<button id="buttonLogin" type="submit" class="btn btn-primary block m-b">登 录</button>
                	<button class="btn btn-primary register"><a href="register-n.html" style="color:#fff;display:inline-block;width:100%;">注册</a></button>
                </div>
