...
<body class="gray-bg">
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
		    	<div class="ibox-content" style="height:800px">
		       		<div id="UserDistributionMap" style="height:800px;margin:auto auto"></div>
		        </div>
		 	</div>
		</div>
    </div> 
    ...
    function init(){
  	...
  	//注册用户分布图
    function UserDistributionMap(){
    	var url='<%=path%>/business/electronicBusiness/businessModelDemo/UserAttr/UserDistributionMap.do';
     	...
     	var sFunc = function(data){
			...
			loadEchart(data,'UserDistributionMap');
     	}
     	//获取数据并通过回调函数进行数据加载。
     	ajaxPost(url,{},sFunc); 
    }
