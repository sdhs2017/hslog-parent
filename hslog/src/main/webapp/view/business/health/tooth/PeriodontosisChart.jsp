...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>/tooth/selectYearPeriodontosisLineByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>/tooth/selectYearOrGradePeriodontosisLineByString.do';
  ...
  //点击柱状图
    function PoorsighBar(){
    	var url='<%=path%>/tooth/selectCityPeriodontosisBarByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>/tooth/getPeriodontosisAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.YearPeriodontosisLineByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.YearOrGradePeriodontosisLineByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.CityPeriodontosisBarByString),'PoorsighBar');
    	}
