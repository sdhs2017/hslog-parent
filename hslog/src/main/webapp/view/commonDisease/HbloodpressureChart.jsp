...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>commonDisease/selectYearHbloodpressureByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>commonDisease/selectAgeOrGradeHbloodpressureByString.do';
  ...
  //点击柱状图
    function PoorsighBar(){
    	var url='<%=path%>commonDisease/selectZipcodeHbloodpressureByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>commonDisease/getHbloodpressureAllChart.do';
