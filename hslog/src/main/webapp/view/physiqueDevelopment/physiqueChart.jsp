...
<body class="gray-bg">
    ...
    function PoorsighLine(){
    	var url='<%=path%>physiquedevelopment/selectPhysiqueLineByString.do';
    ...
    function PoorsighLineage(){
		var url='<%=path%>physiquedevelopment/selectAgeOrGradePhysiqueLineByString.do';
   ...
   function PoorsighPie(){
	    var url='<%=path%>physiquedevelopment/selectPhysiquePieByString.do';
  ...
  //点击柱状图
    function PoorsighBar(){
    	var url='<%=path%>physiquedevelopment/selectCityPhysiqueBarByString.do';
    ...
    function getYearOrZipcode(){
    	...
    	var url='<%=path%>physiquedevelopment/getPhysiqueAllChart.do';
    	var param={"ZIPCODE":ZIPCODE,"GRADE":GRADE,"SEX":SEX,"YEAR":YEAR,"COUNT":COUNT};
    	//取值
    	var sFunc=function(data){
    		loadEchart(JSON.parse(data.PhysiqueLineByString),'PoorsighLine');
    		loadEchart(JSON.parse(data.PhysiquePieByString),'PoorsighPie');
    		loadEchart(JSON.parse(data.AgeOrGradePhysiqueLineByString),'PoorsighLineage');
    		loadEchart(JSON.parse(data.CityPhysiqueBarByString),'PoorsighBar');
    	}
