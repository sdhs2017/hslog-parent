                ...
                <li v-for="(i,index) in equipmentList"  :key="index"  class="eq-li" @mouseenter="liMouseenter($event)" @mouseleave="liMouseleave($event)" @>
                    ...
                    <div class="eq-inf">
                        ...
                        <ul class="inf-ul">
                            ...
                            <li class="inf-port">
                                <div class="inf-tit">责任人：</div>
                                <div class="inf-val">{{i.userName}}</div>
                            </li>
                            <li class="inf-port">
                                <div class="inf-tit">责任人电话：</div>
                                <div class="inf-val">{{i.phone}}</div>
                            </li>
                            <li class="inf-port">
                                <div class="inf-tit">责任人角色：</div>
                                <div class="inf-val">{{i.roleNames}}</div>
                            </li>
    ...
    export default {
		...
		data() {
			return {
                ...
                checkList:[],
			    zzIndex:-2,
                busName:'searchAssetOverviewUser',
                size:15,
                c_page:1,
                allCounts:0,
        ...
        methods:{
            ...
            getData(searchObj,page){
                ...
                this.$nextTick(()=>{
                    ...
                    this.$axios.post(this.$baseUrl+'/equipment/selectPageWithRole.do',this.$qs.stringify(obj))
                        .then(res=>{
                            this.loading = false;
...
/*                            this.$nextTick(()=>{
            ...
            /*跳转到添加资产页面*/
            goToAddEquipment(){
                this.$router.push({path:'addAssetOverviewUser'});
            },
            /*跳转到所有资产报表*/
            goToAllEcharts(){
            ...
            reviseEquipment(rowData,index){
                //跳转页面
                jumpHtml('reviseAssetOverviewUser'+rowData.id,'equipment/reviseAssetOverviewUser.vue',{ name:rowData.name,id: rowData.id },'资产修改')
            },
            /*查看资产日志*/
            ...
            goToDashboard(rowData,dId,type){
               ...
               // let logType = rowData.logType;
                ...
                //     jumpHtml('equipmentSIEM'+rowData.id,'equipment/equipmentSIEM.vue',{ name:rowData.name+'统计',id: rowData.id },'查看')
                // }else{
                //     jumpHtml('equipmentDashboard'+rowData.id,'dashboard/dashboard.vue',{ name:rowData.name+'统计',eid: rowData.id,id:dId,type:'EQedit' },'查看')
                // }
